...
namespace projet.Controllers
{
    public class CafesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prix")] Cafe cafe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prix")] Cafe cafe)
        {
            if (id != cafe.Id)
            {
                return NotFound();
        ...
        {
            var produits = await _context.Cafe.ToListAsync();
            return View("ListeProduit", produits);
        }
